...
class test2 {
    int function11 (int i){ return function21(i)+1;}
    int function21 (int i){ return function61(i)+1;}
    int function41 (int i){ return function51(i)+1;}
    int function51 (int i){ return function61(i)+1;}
    int function61 (int i){ return 1;}
  public:
    int function31 (char c){ return function11(c)+1+function41(c);}
};
